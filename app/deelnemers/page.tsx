...
export default function Deelnemers() {
	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-neutral-50 p-8 bg-no-repeat bg-cover" style={{ backgroundImage: "url('/images/finalhomestate.jpg')" }}>
